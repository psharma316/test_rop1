...
with models.DAG(
    ...
    clone_git = BashOperator(
        task_id='clone_git',
        bash_command='gcloud beta compute ssh --zone "us-west4-a" "instance-1" --project "dataproc-usecase-276411" --command="/home/bdondataproc_gmail_com/security/git_clone.sh"',
        dag=dag)
    ...
    clone_git >> create_dataproc_cluster >> dataproc_hive_create_db >> dataproc_hive_create_table_csv >> dataproc_hive_create_table_par >> dataproc_load_csv_table >> dataproc_load_par_table >> dataproc_hive_count_table_csv >> delete_dataproc_cluster >> load_parquet_bqt >> rm_par_file >> count_bq_table 